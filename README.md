...
- Multi-language interface in Portuguese (Brazil), English, Spanish, Italian, German, French, and Japanese for both the operator panel and the customer portal.
...
English, Spanish, Italian, German, French, and Japanese. The active language follows the browser preference on
