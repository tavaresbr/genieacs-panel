...
- Multi-language interface in Portuguese (Brazil), English, Spanish, Italian, and German for both the operator panel and the customer portal.
...
English, Spanish, Italian, and German. The active language follows the browser preference on
