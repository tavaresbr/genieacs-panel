...
- Multi-language interface in Portuguese (Brazil), English, Spanish, Italian, German, and French for both the operator panel and the customer portal.
...
English, Spanish, Italian, German, and French. The active language follows the browser preference on
