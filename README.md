...
- Multi-language interface in Portuguese (Brazil), English, Spanish, Italian, German, French, Japanese, and Simplified Chinese for both the operator panel and the customer portal.
...
English, Spanish, Italian, German, French, Japanese, and Simplified Chinese. The active language follows the browser preference on
